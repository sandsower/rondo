...
- Rondo is a scheduler/runner and tracker reader.
...
Rondo is easiest to port when kept in these layers:
...
- `root` (path string or `$VAR`)
  - Default: `<system-temp>/rondo_workspaces`
...
- `GET /api/v1/<issue_identifier>`
  ...
  - Suggested response shape:
    ...
    ```json
    {
      ...
      "status": "running",
      "workspace": {
        "path": "/tmp/rondo_workspaces/MT-649"
      },
      "attempts": {
        "restart_count": 1,
      ...
      "logs": {
        "claude_session_logs": [
          {
            "label": "latest",
            "path": "/var/log/rondo/claude/MT-649/latest.log",
            "url": null
          }
        ]
      },
