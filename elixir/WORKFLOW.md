...
Kimi and DeepSeek coverage runs through OpenRouter (`openrouter/...`). Do not replace these with
...
5.  Ensure the workpad includes a compact environment stamp at the top as a code fence line:
    ...
    - Example: `devbox-01:/home/dev-user/code/rondo-workspaces/MT-32@7bdde33bc`
...
8.  Attach PR URL to the issue (prefer attachment; use the workpad comment only if attachment is unavailable).
    - Ensure the GitHub PR has label `rondo` (add it if missing).
...
- Required PR metadata is present (`rondo` label).
