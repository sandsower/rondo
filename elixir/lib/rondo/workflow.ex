defmodule Rondo.Workflow do
  ...
  def workflow_file_path do
    Application.get_env(:rondo, :workflow_file_path) ||
      Path.join(File.cwd!(), @workflow_file_name)
  end

  @spec set_workflow_file_path(Path.t()) :: :ok
  def set_workflow_file_path(path) when is_binary(path) do
    Application.put_env(:rondo, :workflow_file_path, path)
    maybe_reload_store()
    :ok
  end
  ...
  def clear_workflow_file_path do
    Application.delete_env(:rondo, :workflow_file_path)
    maybe_reload_store()
    :ok
  end
