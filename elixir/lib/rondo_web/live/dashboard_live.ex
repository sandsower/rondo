                  ...
                  >
                    <td>
                      <div class="issue-stack">
                        ...
                        <% latest_run_model = run_model_info(List.last(group.runs) || %{}) %>
                        <div class="model-badge-row">
                          <span class={provider_badge_class(latest_run_model.provider)}><%= latest_run_model.provider || "unknown" %></span>
                          <span class="model-chip"><%= latest_run_model.model || latest_run_model.adapter || "unknown" %></span>
                        </div>
                      </div>
                    </td>
